...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// because javascript has what is called closure. nested functions can pull data from parent functions.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseArray = array.map(i => {
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop = array.filter(i => i.population < 5)
    return lowPop
  }
  ...
  */
  ...
  function USApop(array){
    const USpop = array.reduce((acc, val) => {
